...
#| A list prints with a quote mark before it, but
if an element of a list is itself a list, then no 
quote mark is printed for the inner list: |#

(list (list 1) (list 2 3) (list 4))
;; '((1) (2 3) (4))

#| For nested lists, especially, the quote form lets 
you write a list as an expression in essentially the 
same way that the list prints: |#
...
whether the quoted form is normalized by the 
dot-parenthesis elimination rule or not: |#
...
#| If you wrap an identifier with quote, then you 
get output that looks like an identifier, but 
with a ' prefix: |#
